...
type LSM9DS1 struct {
	...
	Gx, Gy, Gz int16 // x, y, and z axis readings of the gyroscope
	Ax, Ay, Az int16 // x, y, and z axis readings of the accelerometer
	Mx, My, Mz int16 // x, y, and z axis readings of the magnetometer
