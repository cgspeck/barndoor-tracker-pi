...
type LSM9DS1 struct {
	...
	G        *MutexReading // x, y, and z axis readings of the gyroscope
	A        *MutexReading // x, y, and z axis readings of the accelerometer
	M        *MutexReading // x, y, and z axis readings of the magnetometer
